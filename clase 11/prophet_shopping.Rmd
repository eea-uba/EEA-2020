...
[Prophet](https://facebook.github.io/prophet/) es un software de código abierto lanzado por Facebook.
...
La funcion `performance_metrics` computa varias métricas de performance a partir de un dataframe de cross validation de prophet. 
